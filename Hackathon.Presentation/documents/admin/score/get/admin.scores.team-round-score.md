...
3. **scopeScore** = SUM(Scores.TotalScore) — **chỉ tính các Score có TotalScore != null** (các judge đã chấm xong). Nếu chưa có judge nào chấm xong, scopeScore = 0.
...
| `totalScore` | **scopeScore** = tổng điểm của các judge **đã chấm xong** (chỉ lấy Score có TotalScore != null). Nếu chưa có judge nào chấm xong, scopeScore = 0 |
