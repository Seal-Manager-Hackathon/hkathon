# GET /api/v1/lecturer/teams/recent

> Lecturer lấy 10 teams được tạo gần nhất.

**Controller:** [LecturerTeamController.cs](Controllers/Lecturer/LecturerTeamController.cs)

## Nghiệp vụ

**Router:** `GET /api/v1/lecturer/teams/recent`

- Giống Admin về format response, khác auth là Lecturer.
