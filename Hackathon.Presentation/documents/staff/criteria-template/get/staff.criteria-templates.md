...
> **Ref:** [Admin API tương ứng](/api/v1/admin/rounds/{roundId}/criteria-templates) — [`admin/criteria-template/get/admin.criteria-templates.list.md`](../../../admin/criteria-template/get/admin.criteria-templates.list.md)
