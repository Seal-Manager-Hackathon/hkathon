...
> **Ref:** [Admin API tương ứng](/api/v1/admin/register-teams/{registerTeamId}/reject) — [`admin/register-team/post/admin.register-teams.reject.md`](../../../admin/register-team/post/admin.register-teams.reject.md)
