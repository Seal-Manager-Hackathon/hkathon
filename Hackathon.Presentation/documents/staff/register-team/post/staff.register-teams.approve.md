...
> **Ref:** [Admin API tương ứng](/api/v1/admin/register-teams/{registerTeamId}/approve) — [`admin/register-team/post/admin.register-teams.approve.md`](../../../admin/register-team/post/admin.register-teams.approve.md)
