...
> **Ref:** [Admin API tương ứng](/api/v1/admin/register-teams/{registerTeamId}) — [`admin/register-team/get/admin.register-teams.detail.md`](../../../admin/register-team/get/admin.register-teams.detail.md)
