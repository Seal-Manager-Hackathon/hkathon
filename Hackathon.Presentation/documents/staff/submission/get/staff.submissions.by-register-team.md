...
> **Ref:** [Admin API tương ứng](/api/v1/admin/register-teams/{registerTeamId}/submissions) — [`admin/submission/get/admin.register-teams.submissions.md`](../../../admin/submission/get/admin.register-teams.submissions.md)
