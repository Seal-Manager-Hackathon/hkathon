...
> **Ref:** [Admin API tương ứng](/api/v1/admin/notifications/{notificationId}) — [`admin/notification/patch/admin.notifications.update.md`](../../../admin/notification/patch/admin.notifications.update.md)
