...
> **Ref:** [Admin API tương ứng](/api/v1/admin/notifications/{notificationId}/delete) — [`admin/notification/post/admin.notifications.delete.md`](../../../admin/notification/post/admin.notifications.delete.md)
