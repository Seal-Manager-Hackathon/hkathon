# POST /api/v1/staff/events/chapter/{year}/leaderboard/hide

> Staff ẩn (soft-delete) leader board chapter cho một năm — set IsDisable=true.

## Nghiệp vụ

Staff muốn ẩn kết quả leader board của một năm. Hệ thống sẽ:
...
> **Ref:** [Admin API tương ứng](/api/v1/admin/leaderboard/post/admin.chapter.hide.md)
