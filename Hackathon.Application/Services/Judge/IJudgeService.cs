...
public interface IJudgeService
{
    ...
    Task<UpdateScoreResponse> UpdateScoreBySubmission(Guid submissionId, SubmitScoreRequest request, int pageIndex = 1, int pageSize = 10);
    ...
    Task<JudgeMyScoreBySubmissionResponse> GetMyScoreBySubmission(Guid submissionId);
}
